...
APP_VERSION = AppVersion(1, 3, 14, "release_candidate")
...
VIEWER_NODE_RELATED_VAR_NAMES = (
    ...
    VISUAL_AND_OUTPUT_BACKDOOR_VAR_NAME,
    VISUAL_LOOP_AND_OUTPUT_BACKDOOR_VAR_NAME,
    ...
    "visual_and_output_backdoor",
    "visual_loop_and_output_backdoor",
