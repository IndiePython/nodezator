"""Facility with operations for system testing case 0008."""
...
def perform_setup(data):
    ...
    with ZipFile(
        str(SYSTEM_TESTING_DATA_DIR / 'test_cases' / 'stc0008.zip'),
        mode='r',
    ) as archive:
...
FRAME_ASSERTION_MAP[50] =  ensure_items_exist_and_are_selected


perform_final_assertions = ensure_items_exist_and_are_deselected
