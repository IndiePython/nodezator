"""Facility with operations for system testing case 0011."""
...
def perform_setup(data):
    ...
    with ZipFile(
        str(SYSTEM_TESTING_DATA_DIR / 'test_cases' / 'stc0011.zip'),
        mode='r',
    ) as archive:
...
FRAME_ASSERTION_MAP[20] =  ensure_items_exist_and_are_selected
