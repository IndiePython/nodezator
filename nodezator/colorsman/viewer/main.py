...
class ColorsViewer(ColorListMode, PatternsMode, LoopHolder):
    ...
    def build_mode_behaviour_map(self):
        ...
        ### locally as well
        memory_freeing_behaviours = self.memory_freeing_behaviours = \
                                                  CallList()
        ...
        for mode_name in MODE_NAMES:
            ...
            for behaviour_name in BEHAVIOUR_NAMES:
                ...
                if behaviour_name == 'free_up_memory':
                    memory_freeing_behaviours.append(
                                                behaviour
                                              )
    ...
    def set_mode(self, mode_name):
        ...
        for behaviour_name, behaviour \
        in behaviour_map.items():
    ...
    def view_colors(self, color_value, mode=None):
        ...
        self.colors = custom_format_color(
                         color_value,
                         'rgb_ints',
                         False
                      )
        ...
        if mode is None: mode = self.mode_options.get()
