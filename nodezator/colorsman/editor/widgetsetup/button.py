...
def setup_buttons(self):
    ...
    buttons.extend(
              ...
              for ordinal, color, rotation_degrees, flip_x
    ...
    equal_equal = combine_surfaces(
                    ...
                    offset_pos_by=(-(ICON_PADDING*3)//2,0)
                  )
    ...
    alpha_checkbutton = \
    self.alpha_checkbutton = CheckButton(
                               value = False,
                               size  = 18,
                               name  = "use_alpha"
                             )
    ...
    buttons.extend(
              (alpha_checkbutton, alpha_checkbutton_label)
            )
    ...
    move_left_button.rect.topleft = \
        colors_panel.rect.move(85, 5).bottomleft
    ...
    move_right_button.rect.topleft = \
                  move_left_button.rect.move(5, 0).topright
    ...
    remove_color_button.rect.topleft = \
              move_right_button.rect.move(5, 0).topright
    ...
    add_color_button.rect.topleft = \
          remove_color_button.rect.move(5, 0).topright
    ...
    sort_colors_button.rect.midleft = \
    color_add_option_menu.rect.move(20, 0).midright
    ...
    reverse_order_button.rect.midleft = \
    color_sorting_holder.rect.move(20, 0).midright
    ...
    shuffle_button.rect.topleft = \
               reverse_order_button.rect.move(5, 0).topright
    ...
    remove_duplicates_button.rect.topleft = \
                  shuffle_button.rect.move(5, 0).topright
    ...
    html_colors_button.rect.topleft = \
           colors_panel.rect.move(25, 38).bottomleft
    ...
    pygame_colors_button.rect.topleft = \
           html_colors_button.rect.move(5, 0).topright
    ...
    import_colors_button.rect.topleft = \
    pygame_colors_button.rect.move(5, 0).topright
    ...
    export_colors_button.rect.topleft = \
    import_colors_button.rect.move(5, 0).topright
    ...
    cancel_button.on_mouse_release = \
    ...
    midright = \
      self.scale_map["alpha"].rect.move(-10, 0).midleft
    ...
    midleft = \
        remove_duplicates_button.rect.move(5, 0).midright
    view_button.rect.midleft = midleft

    view_button.on_mouse_release = \
                      get_oblivious_callable(
                        colors_panel.view_colors
                      )
