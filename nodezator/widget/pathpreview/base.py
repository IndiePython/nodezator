...
class _BasePreview(Object2D):
    ...
    def validate_value(self, value):
        ...
        ### checked
            ...
            if not len(value):
                ...
                raise ValueError(
                  "if 'value' is of 'tuple' type, it must"
                  " not be empty"
                )
        ...
        ### TypeError with suitable message
            ...
            raise TypeError(
              "'value' must be of type 'str' or 'tuple'"
            )
    ...
    def update_image(self):
        ...
        ### if there's just one path, though...
            ...
            self.current_path = (
              value if value_is_string else value[0]
            )
        ...
        for surf, rect in zip(
          self.button_surfs, self.button_rects
        ):
    ...
    def on_mouse_release(self, event):
        ...
        rel_mouse_pos = [
          a - b for a, b in zip(event.pos, self.rect.topleft)
        ]
        ...
        if self.collides_with_entry(event.pos): return
    ...
    def blit_path_representation(self):
        ...
        self.image.blit(
                     ...
                     self.button_rects[1].move(1, 0).topright
                   )
    ...
    def get_expected_type(self):
        ...
        if self.string_when_single: classes.add(str)
    ...
    def svg_repr(self):
        ...
        for button_svg_repr, rect in zip(
          self.button_svg_reprs, self.button_rects
            ...
            for path_directives, style \
            in button_svg_repr:

                path_directives = (
                  first_directive + path_directives
                )
    ...
    def svg_path_repr(self):
        ...
        button_topright = (
          self.button_rects[1].move(2, 1).topright
        )

        x, y = (
          value + offset
          for value, offset
          in zip(button_topright, self.rect.topleft)
        )
