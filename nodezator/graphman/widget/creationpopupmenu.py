...
from .picker.main import pick_widget
...
class WidgetCreationPopupMenu(MenuManager):
    ...
    def __init__(self):
        ...
        command = (
          self.trigger_subparameter_widget_instantiation
        )
    ...
    def trigger_simple_widget_picking(
          self, node, *other_references
        ):

        self.node_waiting_widget_refs = (
    ...
    def trigger_subparameter_widget_instantiation(
        ...
        else: widget_data = deepcopy(widget_data)
