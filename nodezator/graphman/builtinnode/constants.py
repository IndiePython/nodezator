...
def _any(iterable:Iterable) -> [
  {'name': 'boolean', 'type': bool}
]: pass

def _ascii(obj) -> [{'name': 'string', 'type': str}]: pass

def _bin(x) -> [{'name': 'string', 'type': str}]: pass

def _bool(obj=False) -> [
  {'name': 'boolean', 'type': bool}
]: pass

def _bytearray1(source:int=0) -> [
  {'name': 'bytearray_obj', 'type': bytearray}
]: pass

def _bytearray2(source:str='', encoding:str='utf-8') -> [
  {'name': 'bytearray_obj', 'type': bytearray}
]: pass

def _bytearray3(source:str='', encoding:str='utf-8', errors:str='strict') -> [
  {'name': 'bytearray_obj', 'type': bytearray}
]: pass

def _bytes1(source:int=0) -> [
  {'name': 'bytes_obj', 'type': bytes}
]: pass

def _bytes2(source:str='', encoding:str='utf-8') -> [
  {'name': 'bytes_obj', 'type': bytes}
]: pass

def _bytes3(source:str='', encoding:str='utf-8', errors:str='strict') -> [
  {'name': 'bytes_obj', 'type': bytes}
]: pass
...
def _chr(
    ...
    ) -> [{'name': 'char_string', 'type': str}]: pass
...
def _compile(
    ...
    ) -> [{'name': 'code_or_ast_obj'}]: pass

def _complex1(number_or_string:str='0j') -> [
...
def _complex2(
    real: (int, float) = 0,
    imag: (int, float) = 0,
  ) -> [{'name': 'complex_number', 'type': complex}]: pass

def _dict1(**kwargs) -> [
  {'name': 'dict_obj', 'type': dict}
]: pass

def _dict2(mapping_or_iterable, **kwargs) -> [
  {'name': 'dict_obj', 'type': dict}
]: pass
...
def _divmod(
      x:(int, float) = 0,
      y:(int, float) = 1,
    ) -> [{'name': 'q_and_r_pair', 'type': tuple}]: pass

def _enumerate(iterable:Iterable, start:int=0) -> [
...
def _filter(
      function:Callable,
      iterable:Iterable,
    ) -> [{'name': 'filter_obj', 'type': Iterator}]: pass

def _float(number_or_string:str='0.0') -> [
  {'name': 'float_obj', 'type': float}
]: pass

def _format(value, format_spec:str='') -> [
  {'name': 'formatted_repr', 'type': str}
]: pass

def _frozenset(iterable:Iterable=()) -> [
  {'name': 'frozentset_obj', 'type': frozenset}
]: pass

def _getattr1(obj, name:str=''): pass
...
def _hash(obj) -> [
  {'name': 'hash_value', 'type': int}
]: pass

def _hex(x:int=0) -> [
  {'name': 'hex_string', 'type': str}
]: pass

def _id(obj) -> [
  {'name': 'identity_int', 'type': int}
]: pass

def _int1(number_or_string:'python_literal'='0') -> [
...
def _issubclass(obj, class_or_tuple) -> [
  {'name': 'boolean', 'type': bool}
]: pass
...
def _iter2(callable_obj:Callable, sentinel) -> [
  {'name': 'iterator', 'type': Iterator}
]: pass

def _len(obj) -> [
  {'name': 'length_int', 'type': int}
]: pass

def _list(iterable:Iterable=()) -> [
...
def _map(
      function: Callable,
      *iterables:Iterable,
    ) -> [{'name': 'map_obj', 'type': Iterator}]: pass

def _max1(iterable:Iterable, **kwargs): pass
def _max2(*args, **kwargs): pass

def _min1(iterable:Iterable, **kwargs): pass
def _min2(*args, **kwargs): pass

def _memoryview(obj) -> [
  {'name': 'memoryview_obj', 'type': memoryview}
]: pass

def _next1(iterator:Iterator): pass
def _next2(iterator:Iterator, default:'python_literal'=None): pass

def _oct(x:int=0) -> [
  {'name': 'oct_string', 'type': str}
]: pass
...
def _range1(*args:int) -> [
  {'name': 'range_obj', 'type': Iterable}
]: pass

def _range2(stop:int=0) -> [
  {'name': 'range_obj', 'type': Iterable}
]: pass
...
def _range3(
      start : int = 0,
      stop  : int = 0,
    ) -> [{'name': 'range_obj', 'type': Iterable}]: pass
...
def _repr(obj) -> [{'name': 'string', 'type': str}]: pass

def _reversed(sequence: Sequence) -> [
  {'name': 'iterator', 'type': Iterator}
]: pass
...
def _round(
      number  : float = 0.0,
      ndigits : int   = None,
    ) -> [{'name': 'number', 'type': (int, float)} ]: pass
...
def _sorted(
      ...
      *,
      key:Callable=None,
      reverse:bool=False,
    ) -> [{'name': 'sorted_list', 'type': list}]: pass

def _set(iterable:Iterable=()) -> [
  {'name': 'set_obj', 'type': set}
]: pass
...
def _slice(
      ...
      stop  : int = None,
      step  : int = None,
    ) -> [{'name': 'slice_obj', 'type': slice}]: pass
...
def _str2(
    ...
    ) -> [{'name': 'str_obj', 'type': str}]: pass

def _sum(iterable:Iterable, start:int=0): pass

def _tuple(iterable:Iterable=()) -> [
  {'name': 'tuple_obj', 'type': tuple}
]: pass
...
def _type2(
      ...
      bases  : tuple  = (),
      a_dict : dict   = {},
    ) -> [{'name': 'type_obj', 'type': type}]: pass

def _vars(obj) -> [{'name': 'a_dict', 'type': dict}]: pass

def _zip(*iterables:Iterable) -> [
  {'name': 'zip_obj', 'type': Iterator}
]: pass
