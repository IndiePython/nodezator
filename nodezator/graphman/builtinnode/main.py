...
class BuiltinNode(CallableNode):
    ...
    def __init__(self, data, midtop=None):
        ...
        ### own attribute
        self.main_callable = BUILTIN_IDS_TO_CALLABLES_MAP[data["builtin_id"]]
        ...
        ) = BUILTIN_IDS_TO_SIGNATURE_CALLABLES_MAP[data["builtin_id"]]
    ...
    def get_signature(self):
        ...
        """
        return BUILTIN_IDS_TO_SIGNATURES_MAP[self.data["builtin_id"]]
    ...
    def get_source_info(self):
        ...
        return BUILTIN_IDS_TO_SOURCE_VIEW_TEXT[self.data["builtin_id"]]
