...
TEXT_BLOCK_FG = (
  COMMENT_THEME_MAP
  ['text_settings']['normal']['foreground_color']
)
...
IMAGE_ICON = render_layered_icon(
               ...
               chars=[
                 chr(ordinal) for ordinal in (38, 40, 41, 39)
               ],
...
INFO_ICON = render_layered_icon(
              chars=[
                chr(ordinal) for ordinal in (167, 63, 64, 168)
              ],
...
ARROW_DOWN_ICON = render_layered_icon(
                    chars=[
                      chr(ordinal) for ordinal in (50, 51)
                    ],
...
SSD_ICON = render_layered_icon(
             ...
             chars=[
               chr(ordinal) for ordinal in range(83, 87)
             ],
